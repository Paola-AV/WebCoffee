...
export function HistoriaSc() {
    ...
    return (
        <section class="w-full bg-[#f0bc84] pb-10 grid ">
            ...
            <div class="flex flex-row justify-center justify-self-center font-lucida mt-10 p-3 mb-10 xl:w-[80%]">
            ...
            <div class="flex flex-row justify-center font-lucida mt-10 p-3 mb-10 justify-self-center xl:w-[80%]">
                ...
                <div class="hidden lg:flex z-[1000]">
                    <img src={NgranosTostadora} class="rounded-full border-8 border-[#424530]" />
                </div>
            ...
            <div class="flex flex-row justify-center font-lucida mt-10 p-3 mb-10 justify-self-center xl:w-[80%]">
                <div data-aos="fade-up" class="w-[85%] flex flex-col justify-center">
                    <div class="bg-[#FFEFCD] shadow-xl w-full  rounded-bl-[4rem] pr-[10rem] pl-1">
                ...
                <div class="hidden lg:grid z-[1000]">
                    <img src={NchemexPouring}  class="rounded-full border-8 border-[#424530] justify-self-center w-[15rem] absolute self-center" />
                </div>

                <div data-aos="fade-up" class="w-[85%] flex flex-col justify-center">
                    <div class="bg-[#FFEFCD] shadow-xl w-full p-2 rounded-tr-[4rem] pl-[10rem] translate-x-[-2rem]">
                        <h2 class="font-semibold pt-4 pl-1">Lorem Ipsum</h2>
                        <p >
                            Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. 
                        </p>
