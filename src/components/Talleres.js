        ...
        <section class="grid pt-[10rem]  bg-[#FFEFCD]">
            ...
            <div class="justify-self-center w-[60%] mt-[5rem] 2xl:w-[70%]">
                ...
                <div class="bg-[#E09132] rounded-full w-[20rem] h-[20rem] mb-[10rem] grid items-center 2xl:w-[25rem] 2xl:h-[25rem]">
                    <div class="bg-[#424530] w-[45%] absolute left-[20rem] h-[30%] grid grid-cols-1 justify-around lg:max-xl:left-[17rem] h-[25%] 2xl:h-[20%] 2xl:w-[35%] left-[23rem]">
                ...
                <div class="bg-[#424530] rounded-full w-[20rem] h-[20rem] mb-[10rem] grid items-center 2xl:w-[25rem] 2xl:h-[25rem]">
                    <div class=" bg-[#FFEFCD] w-[45%] absolute left-[20rem] h-[30%] grid grid-cols-1 justify-around lg:max-xl:left-[17rem] h-[25%] 2xl:h-[20%] 2xl:w-[35%] left-[23rem]">
                        <img src={TallerT} class="w-[10rem] h-auto absolute self-center ml-[3rem] lg:max-xl:ml-[1rem] xl:ml-[2rem] xl:max-2xl:w-[11.5rem] 2xl:w-[12rem]"></img>
