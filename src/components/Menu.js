    ...
    return (
        <section class="w-full bg-[#FFEFCD] pb-10 grid lg:pb-[10rem]">
            ...
            <div class="flex flex-row w-full justify-center">
                <div class="p-1 m-1 sm:w-[45%]">
                    <div class="bg-[#FFFFFF] shadow-xl p-2 px-6 rounded-xl m-1 font-lucida lg:flex flex-row pl-0 pr-6 mb-[5rem]">
                        <div class="hidden lg:flex w-1/3 justify-start relative items-start">
                            <img class="absolute left-0 top-0 translate-y-[-2rem] w-[75%] rounded-full" src={vasoMenu}/>
                        </div>
                    ...
                    <div class="bg-[#FFFFFF] shadow-xl p-2 px-6 rounded-xl m-1 font-lucida mt-4 lg:flex flex-row pl-0 pr-6">
                        <div class="hidden lg:flex w-1/3 justify-start relative items-start">
                            <img class="absolute left-0 top-0 translate-y-[-2rem] w-[75%] rounded-full" src={copa1}/>
                        </div>
                        <div class="lg:w-2/3 text-center">
                ...
                <div class="p-1 m-1 sm:w-[45%]">
                    ...
                    <div class="bg-[#FFFFFF] shadow-xl p-2 px-6 rounded-xl m-1 font-lucida lg:flex flex-row pl-0 pr-6 mb-[5rem]">
                        <div class="hidden lg:flex w-1/3 justify-start relative items-start">
                            <img class="absolute left-0 top-0 translate-y-[-2rem] w-[75%] rounded-full" src={latte}/>
                        </div>
                        <div class="lg:w-2/3 text-center">
                    ...
                    <div class="bg-[#FFFFFF] shadow-xl p-2 px-6 rounded-xl m-1 font-lucida mt-4 lg:flex flex-row pl-0 pr-6">
                        <div class="hidden lg:flex w-1/3 justify-start relative items-start">
                            <img class="absolute left-0 top-0 translate-y-[-2rem] w-[75%] rounded-full" src={menuPouring}/>
                        </div>
                        <div class="lg:w-2/3 text-center">
