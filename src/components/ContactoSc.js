...
export function ContactoSc() {
    return (
        <section class="w-full bg-[#FFEFCD] pb-10 flex flex-col items-center text-center">
            <Contacto></Contacto>
            <div>
                <div class="font-lucida">
                ...
                <div>
                    ...
                    <div class="flex flex-row justify-end pt-2">
                        <a href="https://ul.waze.com/ul?place=ChIJs7XV1TlFoI8RMsU9vn5TKlk&ll=10.05869750%2C-84.43503250&navigate=yes&utm_campaign=default&utm_source=waze_website&utm_medium=lm_share_location" target="_blank"><FaWaze class="w-5 h-auto mr-1 text-[#424530]"></FaWaze></a>
                        <a href="https://goo.gl/maps/VrF3puzghGjjmSVS6" target="_blank"><FaMapMarkerAlt class="w-5 h-auto ml-1 text-[#424530]"></FaMapMarkerAlt></a>
                    </div>
                </div>
            </div>
        </section>
